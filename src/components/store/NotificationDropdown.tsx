    ...
    >
      ...
      <div className="max-h-80 overflow-y-auto">
        ...
        {!loading && !error && notifications.length === 0 && (
          <p className="p-4 text-center text-sm text-muted-foreground">{t("No notifications yet.")}</p>
        )}
        {!loading && !error && notifications.length > 0 && (
              ...
              <li key={n.id}>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <time dateTime={n.createdat} className="mt-0.5 text-xs text-muted-foreground">{timeAgo(n.createdat, t)}</time>
                  </div>
                </button>
              </li>
            ))}
